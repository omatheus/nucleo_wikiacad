...
public final
    ...
    public
        ...
        switch (modo)
            ...
            case -3:
                {
                WA2Motor.parametro_funcional = parametro;
                }
            break;
            default:
                {
        ...
        new Thread(new Runnable()
            ...
            public
                ...
                try
                    ...
                    if (resultList.isEmpty())
                    ...
                    else if (parametro.toLowerCase().contains(
                          WA2Dados.estes()[0]))
                        {
                        ...
                        new WA2FiltroMinimo(
                              Wikia2tPublicacao.class.getSimpleName().toLowerCase()).impressaoSimples(
                              resultList);
                        }
                    else if (parametro.toLowerCase().contains(
                          WA2Dados.estes()[5]))
            ...
            public
                ...
                try
                    ...
                    if (resultList.isEmpty())
                        ...
                        final
                              Object estruturaConstituida = new WA2Uniao().getEstruturaParticular(
                                    resultList);

                        WA2Motor.informeAlocado().printf(
                              "$Objeto unico com tipagem->%s$\n",
    ...
    public final synchronized
          String getDiretivaRetornoBruto()
        {

        final
              StringBuffer alocador = new StringBuffer();
        ...
        new Thread(
            ...
            public
                ...
                try
                    ...
                    WA2Motor.informeAlocado().printf(
                          "$getDiretivaRetornoBruto em andamento! Solicitada em %d$\n",
                          new Date().getTime());
                    ...
                    final
                          Query q = session.createQuery(WA2Motor.parametro_funcional);
                    ...
                    if (resultList.isEmpty())
                        ...
                        WA2Motor.informeAlocado().printf(
                              "$Retorno em processamento desde %d$\n",
                              new Date().getTime());
                        ...
                        for (int index = 0;
                            ...
                            alocador.append(
                                  (String) resultList.get(index) + WA2Motor._separador_local[0]
                                  + WA2Motor._separador_local[1]);
